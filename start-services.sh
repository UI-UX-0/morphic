...
# Script to start the morphic-stack services
# This handles both old and new Docker Compose syntax

echo "Starting morphic-stack services..."
...
echo "You can check the status with: docker compose ps (or docker-compose ps)"